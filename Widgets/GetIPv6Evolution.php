 ...
 *
 */
namespace Piwik\Plugins\IPv6Usage\Widgets;
 ...
 */
class GetIPv6Evolution extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         */
        $config->setSubcategoryId('IPv6Usage_IPv6Usage');

        /**
         * Set the name of the widget belongs to.
         */
        $config->setName('IPv6Usage_IPv6Evolution');
    ...
    {
        $controller = new \Piwik\Plugins\IPv6Usage\Controller();
        return $controller->getIPv6UsageEvolutionGraph();
    }
}